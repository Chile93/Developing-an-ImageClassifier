...
def arg_parser():
    ...
    parser.add_argument('--save_dir', dest="save_dir", action="store", default="./checkpoint")
    parser.add_argument('--learning_rate', dest="learning_rate", action="store", default=0.0008)
    parser.add_argument('--hidden_units', type=int, dest="hidden_units", action="store", default=120)
    parser.add_argument('--epochs', dest="epochs", action="store", type=int, default=9)
...
def network_trainer(Model, Trainloader, Testloader, Device, 
    ...
    if type(Epochs) == type(None):
        Epochs = 19
        print("Number of Epochs specificed as 19.")    
